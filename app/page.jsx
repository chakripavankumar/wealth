...
export default function Home() {
  return (
        ...
        <div className="mt-40" >
          ...
          <section className="py-20 bg-blue-100"> 
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-2 mg:grid-cols-4 gap-8">
          ...
          <section className="py-20 ">
            <div className="container mx-auto px-4">
           <h2 className="text-3xl font-bold text-center mb-12">Every you need to manage in financces</h2>
      ...
      {/* Start free trail */}
      <section id="testimonials" className="py-20 bg-blue-500">
